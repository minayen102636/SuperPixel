...
public class trap_sampleball : MonoBehaviour
{
    ...
    public GameObject chan3;
    public GameObject chan4;
    ...
    void Update()
    {
        if (change == false)
        {
            ...
            chan1.GetComponent<SpriteRenderer>().sortingOrder = 2;
            chan2.GetComponent<SpriteRenderer>().sortingOrder = 2;
            chan3.GetComponent<SpriteRenderer>().sortingOrder = 2;
            chan4.GetComponent<SpriteRenderer>().sortingOrder = 2;
        ...
        if (Input.GetKey(KeyCode.Space))
        {
            ...
            chan1.GetComponent<SpriteRenderer>().sortingOrder = 0;
            chan2.GetComponent<SpriteRenderer>().sortingOrder = 0;
            chan3.GetComponent<SpriteRenderer>().sortingOrder = 0;
            chan4.GetComponent<SpriteRenderer>().sortingOrder = 0;
